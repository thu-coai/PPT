...
SAVE_PATH="${WORKING_DIR}/results/ocnli/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}_num${NUM}/seed${SEED}/"
...
OPTS+=" --data-name ocnli_from_pretrain"
