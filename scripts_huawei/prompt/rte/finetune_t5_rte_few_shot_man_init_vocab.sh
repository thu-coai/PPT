...
SAVE_PATH="${WORKING_DIR}/results/rte/few-shot/lr${LR}_G${GRAD_ACC}_prompt_init_vocab_limit1000_man_num32_bs8/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_full_model.json"
TOKENIZER_PATH="${WORKING_DIR}/vocab_en"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/rte/rte_init_vocab.json"
