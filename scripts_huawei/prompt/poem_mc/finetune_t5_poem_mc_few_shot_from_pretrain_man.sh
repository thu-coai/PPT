...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data/poem_mc/"
...
SAVE_PATH="${WORKING_DIR}/results/poem_mc/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}_man_num${NUM}/seed${SEED}"
...
OPTS+=" --data-name poem_mc_from_pretrain_man"
