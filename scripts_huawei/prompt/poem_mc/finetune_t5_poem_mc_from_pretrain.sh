...
SAVE_PATH="${WORKING_DIR}/results/poem_mc/full-data/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}/seed${SEED}/"
...
OPTS+=" --data-name poem_mc_from_pretrain"
