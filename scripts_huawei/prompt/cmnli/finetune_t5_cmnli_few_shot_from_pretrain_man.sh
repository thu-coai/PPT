...
SAVE_PATH="${WORKING_DIR}/results/cmnli/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}_man_num${NUM}/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_full_model.json"
TOKENIZER_PATH="${WORKING_DIR}/bpe_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/cmnli/cmnli_10_0_0_pretrain.json"
...
OPTS+=" --data-name cmnli_from_pretrain_man"
