...
SAVE_PATH="${WORKING_DIR}/results/race_h/few-shot/lr${LR}_G${GRAD_ACC}_prompt_gen_vocab_num32/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_race_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/sp_t5"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/race/race_init_vocab.json"
...
OPTS+=" --data-name race_h_gen_vocab"
