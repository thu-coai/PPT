...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data_en/cb${NUM}/"
...
SAVE_PATH="${WORKING_DIR}/results/cb/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}_num${NUM}/seed${SEED}/"
