...
SAVE_PATH="${WORKING_DIR}/results/cb/few-shot/lr${LR}_G${GRAD_ACC}_prompt_gen_vocab_num32/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_full_model.json"
TOKENIZER_PATH="${WORKING_DIR}/sp_t5"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/cb/cb_init_vocab.json"
