...
SAVE_PATH="${WORKING_DIR}/results/cb/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_lable2_${CKPT}_${CKPT_ITER}_num32_bs8/seed${SEED}/"
...
OPTS+=" --data-name cb_from_pretrain_label2"
