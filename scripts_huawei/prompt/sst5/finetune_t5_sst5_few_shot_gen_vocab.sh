...
SAVE_PATH="${WORKING_DIR}/results/sst5/few-shot/lr${LR}_G${GRAD_ACC}_prompt_gen_vocab_num32/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_sst2_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/sp_t5"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/sst2/sst2_init_vocab.json"
