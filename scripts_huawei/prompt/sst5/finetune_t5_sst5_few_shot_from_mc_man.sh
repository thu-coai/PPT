...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data_en/sst5"
...
SAVE_PATH="${WORKING_DIR}/results/sst5/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_mc_man_${CKPT}_${CKPT_ITER}_num32/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_sst2_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/sp_t5"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/sst2/sst2_from_pretrain.json"
...
OPTS+=" --data-name sst5_from_mc_man"
