...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data_en/yahoo"
...
SAVE_PATH="${WORKING_DIR}/results/yahoo/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_uni_${CKPT}_${CKPT_ITER}/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_yahoo_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/sp_t5"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/yahoo/yahoo_from_pretrain.json"
