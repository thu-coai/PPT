...
SAVE_PATH="${WORKING_DIR}/results/c3/few-shot/lr${LR}_G${GRAD_ACC}_prompt_init_vocab_1000_gen_num${NUM}/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_c3_prompt.json"
TOKENIZER_PATH="${WORKING_DIR}/vocab_cn"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/c3/c3_10_0_0_init_vocab.json"
