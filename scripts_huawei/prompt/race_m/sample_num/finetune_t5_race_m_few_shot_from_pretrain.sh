...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data_en/race_m${NUM}"

LR=${1-0.01}
GRAD_ACC=${2-1}
SEED=${3-1234}
CKPT=${5-nss_10g_1_1_4_fix_lr0.1}
CKPT_ITER=${6-8000}
...
SAVE_PATH="${WORKING_DIR}/results/race_m/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}_num${NUM}/seed${SEED}/"
