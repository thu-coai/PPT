...
SAVE_PATH="${WORKING_DIR}/results/race_m/few-shot/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_label2_${CKPT}_${CKPT_ITER}_num32/seed${SEED}/"
...
OPTS+=" --data-name race_from_pretrain_label2"
