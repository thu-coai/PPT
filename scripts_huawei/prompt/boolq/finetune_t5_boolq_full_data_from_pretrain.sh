...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data_en/BoolQ_full/"
...
SAVE_PATH="${WORKING_DIR}/results/boolq/full-data/lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}/seed${SEED}/"
