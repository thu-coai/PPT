...
DATA_EXT=".jsonl"
DATA_PATH="/mnt/sfs_turbo/gyx/data_en/race_h/"

LR=${1-0.000005}
GRAD_ACC=${2-1}
SEED=${3-1234}

CONFIG_PATH="${WORKING_DIR}/configs/model/t5_small_config.json"
CKPT_PATH="/mnt/sfs_turbo/gyx/checkpoints/t5-small/t5-MP1/"

SAVE_PATH="${WORKING_DIR}/results/race_h/few-shot/t5_small-fp32/full_model_lr${LR}_G${GRAD_ACC}_num32/seed${SEED}/"
