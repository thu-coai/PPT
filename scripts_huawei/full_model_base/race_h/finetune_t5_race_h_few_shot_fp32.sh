...
CKPT_PATH="/mnt/sfs_turbo/gyx/checkpoints/t5-base/t5-MP1/"

SAVE_PATH="${WORKING_DIR}/results/race_h/few-shot/t5_base-fp32/full_model_lr${LR}_G${GRAD_ACC}_num32/seed${SEED}/"
