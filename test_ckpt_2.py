...
for i in range(4):
    ...
    model2["module"]["encoder.prompt_embeds.weight"] = model1["module"]["encoder.prompt_embeds.weight"]

    # torch.save(d, "/mnt/sfs_turbo/gyx/checkpoints/test_9_29/rng/rng_rank_0{}.pt".format(i))

    torch.save(model2, "/mnt/sfs_turbo/gyx/checkpoints/test_9_29_3/1/mp_rank_0{}_model_states.pt".format(i))