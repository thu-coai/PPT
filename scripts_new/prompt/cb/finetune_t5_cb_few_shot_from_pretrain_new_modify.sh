...
# CKPT_PATH="/mnt/sfs_turbo/gyx/checkpoints/test_9_29_2/"
PROMPT_PATH="${WORKING_DIR}/prompt_embeds/pretrain-${CKPT}-${CKPT_ITER}-modify.pt"

SAVE_PATH="${WORKING_DIR}/results/cb/few-shot-new/modify_lr${LR}_G${GRAD_ACC}_prompt_from_pretrain_${CKPT}_${CKPT_ITER}_num32_bs8/seed${SEED}/"
LOG_FILE="${SAVE_PATH}/log.txt"
DS_CONFIG="${WORKING_DIR}/configs/deepspeed/ds_full_model.json"
TOKENIZER_PATH="${WORKING_DIR}/sp_t5"

PROMPT_CONFIG="${WORKING_DIR}/configs/prompt/cb/cb_from_pretrain.json"
