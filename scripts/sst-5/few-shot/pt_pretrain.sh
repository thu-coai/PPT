...
DATA_EXT=".jsonl"
DATA_PATH="${WORKING_DIR}/downstream_data/English/sst5"
...
PROMPT_PATH="${WORKING_DIR}/pretrained_prompts/pretrain-cls.pt"

SAVE_PATH="${WORKING_DIR}/results/sst5/few-shot-32/ppt/lr${LR}_G${GRAD_ACC}/seed${SEED}/"
