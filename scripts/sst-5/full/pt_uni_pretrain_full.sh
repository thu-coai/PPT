...
DATA_EXT=".jsonl"
DATA_PATH="/data/gyx/ppt_data/public/English/sst5-full"
...
SAVE_PATH="${WORKING_DIR}/results/sst5/full/uni_ppt/lr${LR}_G${GRAD_ACC}/seed${SEED}/"
