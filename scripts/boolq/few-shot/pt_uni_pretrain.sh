...
DATA_EXT=".jsonl"
DATA_PATH="/data/gyx/ppt_data/public/English/boolq/"
...
SAVE_PATH="${WORKING_DIR}/results/boolq/few-shot-32/uni_ppt/lr${LR}_G${GRAD_ACC}/seed${SEED}/"
