...
DATA_EXT=".jsonl"
DATA_PATH="${WORKING_DIR}/downstream_data/English/race_m"
...
PROMPT_PATH="${WORKING_DIR}/pretrained_prompts/pretrain-nss.pt"

SAVE_PATH="${WORKING_DIR}/results/race_m/few-shot-32/ppt/lr${LR}_G${GRAD_ACC}/seed${SEED}/"
